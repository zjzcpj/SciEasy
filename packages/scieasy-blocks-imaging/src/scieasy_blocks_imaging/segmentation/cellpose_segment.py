"""Cellpose-based segmentation using ProcessBlock setup/teardown to load the model once per run — the flagship use case for the Phase 10 setup/teardown lifecycle hooks."""
