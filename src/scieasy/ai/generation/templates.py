...
BLOCK_TEMPLATES: dict[str, str] = {
    ...
    "io": (
        ...
        "- Subclass scieasy.blocks.io.io_block.IOBlock and override load() (for"
        " input direction) or save() (for output direction); IOBlock is an"
        " abstract base class per ADR-028 §D1.\n"
        "\n"
        "Constraints:\n"
