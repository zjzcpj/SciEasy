...
- [#131] Migrate DAGScheduler from string states to BlockState enum — type-safe block state tracking, updated tests and checkpoint serialization boundary (@claude, 2026-04-05, branch: fix/issue-131/scheduler-blockstate-enum, session: 20260405-014315-migrate-dagscheduler-from-string-states)
